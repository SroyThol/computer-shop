...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<div class="row mt-4">
				<?php 
				$sql="SELECT * FROM product WHERE ProName LIKE '$Search' OR ProName LIKE '%Search' OR ProName LIKE '$Search%' OR ProName LIKE '%$Search%' OR ProPrice LIKE '$Search' OR  ProPrice LIKE '%Search' OR  ProPrice LIKE '$Search%' OR  ProPrice LIKE '%$Search%'";
